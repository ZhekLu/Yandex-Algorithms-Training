...
void Tree::TraverseInorderFork()
{
    root->TraverseInorderFork();
}

void Tree::Node::TraverseInorderFork()
{

    if(this->left)
        this->left->TraverseInorderFork();

    if(this->left && this->right)
        cout << this->key << endl;

    if(this->right)
        this->right->TraverseInorderFork();
