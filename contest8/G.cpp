...
void Tree::TraverseInorderBranch()
{
    root->TraverseInorderBranch();
}

void Tree::Node::TraverseInorderBranch()
{

    if(this->left)
        this->left->TraverseInorderBranch();

    if(this->left && !this->right || !this->left && this->right)
        cout << this->key << endl;

    if(this->right)
        this->right->TraverseInorderBranch();
